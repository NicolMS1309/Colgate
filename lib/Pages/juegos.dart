...
class Juegos extends StatefulWidget {
  final MediaArguments juego;

  const Juegos({Key? key, required this.juego}) : super(key: key);
...
class _JuegosState extends State<Juegos> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(children: <Widget>[
        widget.juego.eleccionjuego ? videoPlayer : pictureCarrousel,
        backButton
      ]),
    );
  }
  ...
  @override
  void initState() {
    _controller = VideoPlayerController.asset(widget.juego.juegos);
  ...
  Widget get pictureCarrousel => Expanded(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage(widget.juego.juegos), fit: BoxFit.fitHeight)),
      ));
